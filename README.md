...
Backtest supports optional diagnostics (verbose logs, CSV exports, equity plot) via the `output` section in config.
...
- Store policy JSON files under `policies/` (for example `policies/baseline.json`).
