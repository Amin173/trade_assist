...
def test_regime_breadth_signal_can_gate_risk_on():
    ...
    no_breadth_cfg = RegimeConfig(use_breadth=False, min_confirmations=5, require_anchor_trend=True)
...
def test_regime_anchor_requirement_overrides_other_signals():
    ...
    relaxed_cfg = RegimeConfig(min_confirmations=1, require_anchor_trend=False, use_breadth=False)
    strict_cfg = RegimeConfig(min_confirmations=1, require_anchor_trend=True, use_breadth=False)
